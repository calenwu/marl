...
parser.add_argument('--reward_path', type=str,
					default=rewardpath + 'MAPPO_env_simple_spread_v3_number_3_seed_0.npy',
...
runner.agent_n.load_model('simple_spread_v3', number=3, seed=0, step=10000)
...
for episode in range(5):
	...
	for episode_step in range(runner.args.episode_limit):
		...
		# 	actions[agent] = a_n[i]
		next_states, rewards, dones, _, _ = runner.env.step(a_n[0] if episode_step == 0 else a_n)
